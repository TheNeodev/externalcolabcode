...
def run_script():
    ...
    os.makedirs('/content/rvc/stats/', exist_ok=True)
    ...
    shutil.rmtree('/content/rvc/torchcrepe', ignore_errors=True)
    ...
    shutil.move('/content/torchcrepe/torchcrepe', '/content/rvc/')
